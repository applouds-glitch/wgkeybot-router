...
// SocksServer — минимальный SOCKS5-сервер (только метод no-auth и команды
// CONNECT / UDP ASSOCIATE). DNS резолвится удалённо: домен передаётся прямо в
// dial, поэтому клиенты должны использовать socks5h (remote DNS).
